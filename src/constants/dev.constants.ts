...
export const DEVELOPER_PROJECT_SATELLITE_CARGO_TOML = join(DEVELOPER_PROJECT_SATELLITE_PATH, "Cargo.toml");
export const DEVELOPER_PROJECT_SATELLITE_INDEX_TS = join(DEVELOPER_PROJECT_SATELLITE_PATH, "index.ts");
export const DEVELOPER_PROJECT_SATELLITE_INDEX_MJS = join(DEVELOPER_PROJECT_SATELLITE_PATH, "index.mjs");
